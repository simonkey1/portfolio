...
def create_trend_chart():
    ...
    fig.update_layout(
        ...
        xaxis=dict(
            ...
            title_font=dict(size=14, color='lightskyblue'),  # Títulos del eje X con celeste claro
            tickfont=dict(size=12, color='lightskyblue')  # Etiquetas del eje X con celeste claro
        ),
        yaxis=dict(
            title_font=dict(size=14, color='lightskyblue'),  # Títulos del eje Y con celeste claro
            tickfont=dict(size=12, color='lightskyblue')  # Etiquetas del eje Y con celeste claro
        ),
        legend_title={
            'text': 'Año'
        },
